...
- Solve the issue following the conventions in `AGENTS.md`. In particular: keep changes small and targeted, reuse existing helpers before adding abstractions, keep the frontend framework-free, and write all comments and UI text in English.
