...
- Never mention Codex, Anthropic, Codex, or any other AI/assistant tooling in a pull request title or description. Do not add `Co-Authored-By` trailers, "Generated with" footers, session links, or any other note attributing the work to an AI.
